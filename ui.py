...
class UI:
    ...
    def createW(self,version):
        ...
        cookie=Entry(fad,width=42).pack(side='left')
        ...
        Button(fag,text='取消任务(请用鼠标列表中选择)').pack(anchor='w')
        ...
        fag.grid(row=6,column=0,sticky='w')
    ...
    def showaddu(self):
        ...
        Entry(self.stp,textvariable=self.tmpurl,width=40).grid()
        Button(self.stp,text='添加下载任务',command=self.addurls,width=40).grid()
